...
class AnchorWiseScreenBloc extends StatefulWidget {
  const AnchorWiseScreenBloc({super.key});

  @override
  State<AnchorWiseScreenBloc> createState() => _AnchorWiseScreenBlocState();
}

class _AnchorWiseScreenBlocState extends State<AnchorWiseScreenBloc> {
