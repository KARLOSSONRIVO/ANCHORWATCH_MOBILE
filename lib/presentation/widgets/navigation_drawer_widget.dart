                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildMenuItem(
                        ...
                        itemIndex: 0,
                        onTap: () {
                          NavigationService.handleMainNavigation(
                            context,
                            NavigationIndex.dashboard,
                          );
                        },
                      ),
                      _buildMenuItem(
                      ...
                      _buildMenuItem(
                        context,
                        iconPath:
                            'assets/images/Navigation_Icons/AnchorWise.png',
                        title: 'AnchorWise',
                        currentIndex: currentIndex,
                        itemIndex: 2,
                        onTap: () {
                      ...
                      _buildMenuItem(
                        ...
                        onTap: () {
                          NavigationService.handleSpecialNavigation(
                            context,
                            'contact_support',
                          );
                        },
        ...
        child: Container(
          ...
          decoration: isActive
              ? BoxDecoration(
                  ...
                  border: const Border(
                    right: BorderSide(color: Color(0xFF00BCD4), width: 3),
                  ),
                )
              : null,
          child: Row(
